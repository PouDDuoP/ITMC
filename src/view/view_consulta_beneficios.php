...
if (isset($_SESSION['cedula_empleado']) && !empty($_SESSION['cedula_empleado']) && $_SESSION['status'] === TRUE) {
  if ($_SESSION['perfil'] == 4 || $_SESSION['perfil'] == 2 || $_SESSION['perfil'] == 3 || $_SESSION['perfil'] == 1) {
    ...
    $consulta_tipo = $beneficio->consultar_beneficio($status,$pgconn);
    ...
    <script type="text/javascript">
      function consultar(input){
        ...
        if (input.fecha_desde.value.length != 0 && input.fecha_hasta.value.length != 0) {
          ...
          document.datos.action = "../controller/con_consulta_solicitudes_beneficios.php";
  ...
  <body>
    ...
    <section>
      <form class="form" name='datos' action='#' method='post' autocomplete="off">
        <div class="empleado"> <h2>Consulta solicitudes de beneficios</h2> </div>
        <div class="contenedor">
          <div class="empleado">
              <label>
                ID de la Solicitud de Beneficio
              </label>
        ...
        <div class="contenedor">
          <div class="empleado">
              ...
              <input type="text" required autocomplete="off" onkeypress="return justNumbers(event);" maxlength="8" id="cod_hijo" name="cod_hijo" title="Ingrese la Cedula del Empleado" required />
          </div>

          <div class="empleado">
            <select name="status">
              <option value="">Seleccione el status de la solicitud</option>
