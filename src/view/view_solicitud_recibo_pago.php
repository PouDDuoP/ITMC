  ...
  <body>
    ...
    <section>
      <form class="form" name="datos" autocomplete="off">
        <div class="empleado"><h2>Resibo de pago</h2></div>
        <div class="contenedor">
          ...
          <div class="empleado">
              ...
              <input type="text" autocomplete="off" maxlength="8" id="solicitud" name="solicitud" title="Ingrese la Cedula del Empleado" value = "Constacia de Trabajo" readonly="readonly" disabled/>
              <input type="hidden" autocomplete="off" maxlength="1" id="tipo_solicitud" name="tipo_solicitud" title="Ingrese la Cedula del Empleado" value="1" readonly="readonly"/>
          </div>
        </div>
        <div class="empleado">
            <select name="constancias">
              <option value="">Seleccione su tipo de Recibo</option>
